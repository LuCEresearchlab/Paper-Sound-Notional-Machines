...
\begin{itemize}
    ...
    \item A methodology for analyzing \nms{} with respect to their soundness.
        ...
        an existing \nm{},
        pointing out an unsoundness, and suggesting directions for improvement (Section~\ref{chr:RevealingInconsistencies}).
\end{itemize}

We then present, in Section~\ref{sec:ConcreteSyntax}, a brief discussion
about the abstract and concrete representations of a notional machine.
