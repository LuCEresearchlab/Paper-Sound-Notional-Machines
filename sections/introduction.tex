...
A brief discussion about the abstract and concrete representations of a notional machine
follows
in Section~\ref{sec:ConcreteSyntax}.
We then
evaluate the framework we are proposing to reason about notional machines
by comparing the notional machines analyzed
in Section~\ref{chr:Modeling} and Section~\ref{chr:RevealingInconsistencies}
to an existing dataset of 50 notional machines.
